...
class VisitorLogController extends Controller
{
    ...
    { 
        return view('/admin/visitorlog/index');
    }
    ...
    public function create()
    {
        ...
        return view('/admin/visitorlog/create',['date' => $date]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('/admin/visitorlog/edit' , ['visitorlog' => $visitorlog]);
    }
    ...
    public function view($id)
    {
        ...
        return view('/admin/visitorlog/print',['visitorlog' => $visitorlog]);
    }
    ...
    public function print($id)
    {
        try
        {
            ...
            if($visitorlog->relation=='parent')
            {
                $pdf = PDF::loadView('/admin/visitorlog/parent', $array);
            }
            else
            {
                $pdf = PDF::loadView('/admin/visitorlog/other', $array);
            }
